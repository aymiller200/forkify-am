...
const controlRecipes = async function() {
    try {
        ...
        //1. loading recipe
        await _modelJs.loadRecipe(id) //just manipulates the state, does not return anything
        ;
        //2. Rendering recipe
...
// import { getJSON, sendJSON } from './healpers'
var _healpers = require("./healpers");
const state = {
    recipe: {
    },
    search: {
...
const loadRecipe = async function(id) {
    try {
        const data = await _healpers.AJAX(`${_config.API_URL}/${id}?key=${_config.KEY}`);
...
const loadSearchResults = async function(query) {
    try {
        ...
        const data = await _healpers.AJAX(`${_config.API_URL}?search=${query}&key=${_config.KEY}`);
...
const uploadRecipe = async function(newRecipe) {
    try {
        ...
        // console.log(recipe)
        const data = await _healpers.AJAX(`${_config.API_URL}?key=${_config.KEY}`, recipe);
        state.recipe = creatRecipeObject(data);
...
},{"./config":"k5Hzs","./healpers":"9pkks","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k5Hzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const KEY = 'a2ee3d24-7c98-473e-9962-010c9f8681c7';
...
},{}],"9pkks":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _healpersJs = require("../healpers.js");
class RecipeView extends _viewDefault.default {
    ...
    _generateMarkupIngredient(ing) {
      ...
      <li class="recipe__ingredient">
        ...
        <div class="recipe__quantity">${ing.quantity ? _healpersJs.numberToFraction(ing.quantity).toString() : ''}</div>
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../healpers.js":"9pkks"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class View {
   ...
   */ render(data, render = true) {
    ...
    update(data) {
        ...
        const newDOM = document.createRange().createContextualFragment(newMarkup) //An object of our entire dom
        ;
...
class AddRecipeView extends _viewDefault.default {
    ...
    addHandlerUpload(handler) {
        this._parentElement.addEventListener('submit', function(e) {
            ...
            const dataArr = [
                ...new FormData(this)
            ]; //gives an array of all input field with all values in there
